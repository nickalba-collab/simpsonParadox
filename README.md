...
comparison_plot <- (plot1 + plot2) +
  plot_annotation(
    title = "Simpson's Paradox: Overall vs. Species-Specific Relationships",
    subtitle = "Aggregated trend appears positive, but within species it reverses",
    caption = "Red line: Overall trend. Colored lines: Within-species trends.",
...
![Overall vs. species-specific relationships (Simpson’s
